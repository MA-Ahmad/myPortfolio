...
title: "How to create a blog for your Next.js portfolio website"
category: "web-dev"
...
## 2. Create a [mdx](https://github.com/MA-Ahmad/myPortfolio/blob/main/data/posts/let's-build-Dev.to-clone-with-next.js-%26-chakraui.mdx) file
